...
var ListGroupItem = function (_React$Component) {
    ...
    _createClass(ListGroupItem, [{
        ...
        value: function render() {
            ...
            var otherProps = _objectWithoutProperties(_props, ['active', 'children', 'className', 'disabled', 'level']);

            className = (0, _classnames2.default)('list-group-item', (0, _utils.getComponentLevelClassName)('list-group-item', level), {
                active: active,
                disabled: disabled
            }, className);
