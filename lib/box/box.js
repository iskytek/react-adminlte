...
var Box = function (_React$Component) {
    ...
    _createClass(Box, [{
        ...
        value: function render() {
            ...
            var solid = _props.solid;

            var otherProps = _objectWithoutProperties(_props, ['className', 'children', 'level', 'solid']);

            className = (0, _classnames2.default)('box', (0, _utils.getComponentLevelClassName)('box', level), {
                'box-solid': solid
            }, className);
...
Box.propTypes = {
    ...
    solid: _react2.default.PropTypes.bool
};
