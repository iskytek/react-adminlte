...
var BoxFooter = function (_React$Component) {
    _inherits(BoxFooter, _React$Component);

    function BoxFooter() {
        _classCallCheck(this, BoxFooter);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(BoxFooter).apply(this, arguments));
    }

    _createClass(BoxFooter, [{
        key: 'render',
